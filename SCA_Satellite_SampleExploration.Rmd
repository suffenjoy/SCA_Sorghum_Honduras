...
```{r}
path_sample <- "C:/Users/zt92/Box Sync/sorghum_hondurus/Field_BNDs"
#List all kmz files
...
shapefile(shpall_bnd, file.path(path_gis, "shpall_bnd.shp"))
shapefile(shpall, file.path(path_gis, "shpall.shp"))
